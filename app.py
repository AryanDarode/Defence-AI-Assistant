...
def load_vectorstore(): 
    ...
    # Create vector database automatically if missing 
 
    if not os.path.exists("vectorstore"): 
 
        st.info( 
            "📚 Preparing Defence knowledge base..." 
        ) 
...
with st.sidebar: 
    ...
    st.markdown(
        ...
        **Aryan Darode**  
        ...
        🎓 Student of PCCOE, Pune  

        🤖 Interested in Artificial Intelligence & Machine Learning (AIML)  

        🛡️ Developer of the Defence AI Assistant
        """
    )
...
10. Only answer if the retrieved documents directly 
support the user's question. 
 
11. Do not treat similar-looking terms as the same thing. 
 
12. If a term or abbreviation is not defined in the 
retrieved documents, do not guess its meaning. 
 
13. If the question asks about a specific technical 
term that is not present in the retrieved documents, 
